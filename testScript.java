...
public class testScript {
	...
	* Return Type: void
	* Stack State: NENF
	* Function Description: successful if the top-most plate is popped from the stack else fails.
	*/
	public void fnTest4(){
	...
	* Return Type: void
	* Stack State: NENF
	* Function Description: successful if the plate is pushed on top of the stack else fails.
	*/
	public void fnTest5(){
		int random = rand.nextInt(9);
		int flag = obj.reFillMagazine(random);
	...
	* Return Type: void
	* Stack State: full
	* Function Description: successful if the top-most plate from the stack is popped else fails.
	*/
	public void fnTest7(){
		String message = obj.fireBullet();
		if(message.equals("#Stack Empty")){
